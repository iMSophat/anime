<section class="bg-black rounded-xl h-[30rem] overflow-hidden relative">
    ...
    <div class="absolute h-full w-full flex p-5 flex-col gap-7 z-30 top-0 left-0 right-0">
        ...
        <div>
            ...
            <div class="flex flex-col gap-1">
                <p class="text-base font-medium text-slate-400">Magic / Adventure</p>    
                <h1 class="text-4xl font-bold w-1/2 line-clamp-2 text-white">Trending 4k Wallpaper</h1>
                <p class="text-sm text-slate-300">Anime wallpaper FullHD</p> 
            </div>
