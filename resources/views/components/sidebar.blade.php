<nav id="sidebar" class="sidebar js-sidebar">
    <div class="pphat-min-h-fit">
        <ul>
            <li>
                <a href="" class="pphat-flex pphat-gap-3 pphat-rounded-lg pphat-py-1.5 pphat-px-2 pphat-w-full pphat-items-center pphat-bg-secondary pphat-text-base">
                    <svg class="pphat-h-6 pphat-w-6 pphat-transition-all pphat-duration-300 pphat-flex-shrink-0" viewBox="0 0 32 32" fill="none">
                        ...
                        <path d="M19.177 15.3646H21.7187V17.9062" stroke="#071F43" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg> 
                    <span class="title">
                        Home
                    </span>
            ...
            <li>
                <a href="" class="pphat-flex pphat-gap-3 pphat-rounded-lg pphat-py-1.5 pphat-px-2 pphat-w-full pphat-items-center hover:pphat-bg-secondary pphat-text-base">
                    <svg class="pphat-h-6 pphat-w-6 pphat-transition-all pphat-duration-300 pphat-flex-shrink-0" viewBox="0 0 32 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M22.5068 23.0656V15.161" stroke="#121212" stroke-width="1.5" stroke-linecap="round"/>
                        <path d="M22.5065 7.43433L21.9219 8.12058C18.6813 11.9077 14.335 14.5891 9.49316 15.7964" stroke="#121212" stroke-width="1.5" stroke-linecap="round"/>
                        <path d="M18.783 7.43433H22.5065V11.1452" stroke="#121212" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            ...
            <li>
                <a href="" class="pphat-flex pphat-gap-3 pphat-rounded-lg pphat-py-1.5 pphat-px-2 pphat-w-full pphat-items-center hover:pphat-bg-secondary pphat-text-base">
                    <svg class="pphat-h-6 pphat-w-6 pphat-transition-all pphat-duration-300 pphat-flex-shrink-0" viewBox="0 0 32 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M17.2708 16.5208H23.6249" stroke="#121212" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M14.7292 21.6042H23.6251" stroke="#121212" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
            ...
            <li>
                <a href="" class="pphat-flex pphat-gap-3 pphat-rounded-lg pphat-py-1.5 pphat-px-2 pphat-w-full pphat-items-center hover:pphat-bg-secondary pphat-text-base">
                    <svg class="pphat-h-6 pphat-w-6 pphat-transition-all pphat-duration-300 pphat-flex-shrink-0" height="31" viewBox="0 0 32 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12.1876 27.9584H19.8126C26.1667 27.9584 28.7084 25.4167 28.7084 19.0625V11.4375C28.7084 5.08335 26.1667 2.54169 19.8126 2.54169H12.1876C5.83341 2.54169 3.29175 5.08335 3.29175 11.4375V19.0625C3.29175 25.4167 5.83341 27.9584 12.1876 27.9584Z" stroke="#121212" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            ...
            <li>
                <a href="" class="pphat-flex pphat-gap-3 pphat-rounded-lg pphat-py-1.5 pphat-px-2 pphat-w-full pphat-items-center hover:pphat-bg-secondary pphat-text-base">
                    <svg class="pphat-h-6 pphat-w-6 pphat-transition-all pphat-duration-300 pphat-flex-shrink-0" viewBox="0 0 32 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M4.14307 24.0823L10.4083 19.8758C11.4122 19.2023 12.861 19.2785 13.7633 20.0538L14.1826 20.4223C15.1739 21.2738 16.7752 21.2738 17.7664 20.4223L23.0531 15.8854C24.0443 15.034 25.6456 15.034 26.6368 15.8854L28.7083 17.6646" stroke="#121212" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
            ...
            <li>
                <a href="" class="pphat-flex pphat-gap-3 pphat-rounded-lg pphat-py-1.5 pphat-px-2 pphat-w-full pphat-items-center hover:pphat-bg-secondary pphat-text-base">
                    <svg class="pphat-h-6 pphat-w-6 pphat-transition-all pphat-duration-300 pphat-flex-shrink-0" viewBox="0 0 32 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M12.7339 21.6042H19.266" stroke="#121212" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
